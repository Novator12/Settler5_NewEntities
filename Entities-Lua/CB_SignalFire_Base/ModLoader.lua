...
function ModLoader.Initialize()
	CppLogic.Logic.AddArchive("Pfad des zu ladenden Archivs als String")
	
	CppLogic.ModLoader.AddModel("CB_Signalfire_Base")

	CppLogic.ModLoader.AddEntityType("CB_Signalfire_Base")

	--CppLogic.ModLoader.AddBuildingUpgradeCategory("CB_Signalfire", Entities.CB_Signalfire_Base)  only relevant when you are planning to upgrade with UpgradeCategory in Entity.xml
end
